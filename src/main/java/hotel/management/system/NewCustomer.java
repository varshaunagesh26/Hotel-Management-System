...
public class NewCustomer extends JFrame {
    ...
    public NewCustomer() throws SQLException {
        ...
        JLabel lblReserveRoomNumber = new JLabel("Available Rooms :");
        ...
        try{
            Conn c = new Conn();
            ResultSet rs = c.stmt.executeQuery("select roomnumber from room where availability='Available'");
            while(rs.next()){
        ...
        JLabel checkInTime = new JLabel(sdf.format(date));
