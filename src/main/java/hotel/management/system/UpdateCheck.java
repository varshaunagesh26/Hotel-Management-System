        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try{
                    ...
                    c.stmt.executeUpdate("update customer set roomnumber = '"+s2+"', name = '"+s3+"', status = '"+s4+"', deposit = '"+s5+"' where number = '"+s1+"'");
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try{
                    String s1 = c1.getSelectedItem();
                    Conn c = new Conn();
                    ResultSet rs1 = c.stmt.executeQuery("select * from customer where number = "+s1);
                ...
                try{
                    String total = "";
                    Conn c  = new Conn();
                    ResultSet rs2 = c.stmt.executeQuery("select * from room where roomnumber = "+txt_ID.getText());
                    while(rs2.next()){
